...
# release tag has to agree with what was merged. Nothing here rewrites the
# version; it is only verified.
...
# A commit can carry more than one tag, so it is enough that one matches.
